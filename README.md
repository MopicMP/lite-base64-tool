...
> Lite encode/decode base64 with file support

[![PyPI version](https://badge.fury.io/py/lite-base64-tool.svg)](https://pypi.org/project/lite-base64-tool/)
...
```bash
pip install lite-base64-tool
```

## Quick Start

```python
from lite_base64_tool import tool
...
from lite_base64_tool import batch
